(() => {
  ...
  const I18N = {
    ...
    en: {
      ...
      "contact.whatsappText": "Message on WhatsApp",
      ...
      "services.s3d": "Blue screens, crashes, temps, instability, boot issues. Clear diagnosis + next steps.",
      ...
      "process.note": "Tip: a PCPartPicker link or photos (for troubleshooting) speeds things up.",
      "fit.title": "Who this is best for",
      "fit.subtitle": "Quickly see if I’m the right fit for your project.",
      "fit.goodT": "Great fit if…",
      "fit.good1": "You want a stable, quiet, well-cooled PC",
      "fit.good2": "You want honest advice (no unnecessary upsells)",
      "fit.good3": "You want real testing (temps, load, stability)",
      "fit.good4": "You want clear explanations of what was done",
      "fit.badT": "Maybe not ideal if…",
      "fit.bad1": "You only want the lowest possible price",
      "fit.bad2": "You want a rushed build with no planning",
      "fit.bad3": "You want aggressive overclocking with no compromises",
      "fit.bad4": "You don’t want any post-build testing",
      "qa.title": "Before I hand over the PC",
      "qa.subtitle": "A simple checklist so everything is clean, stable, and ready.",
      "qa.c1t": "Stability",
      "qa.c1b1": "Basic stress tests / checks",
      "qa.c1b2": "RAM (XMP/EXPO) verified",
      "qa.c1b3": "Storage checked",
      "qa.c2t": "Temperatures & noise",
      "qa.c2b1": "CPU/GPU temps under load",
      "qa.c2b2": "Airflow & cables secured",
      "qa.c2b3": "Fan curves (quiet / performance)",
      "qa.c3t": "Setup",
      "qa.c3b1": "BIOS updated when relevant",
      "qa.c3b2": "Essential drivers installed",
      "qa.c3b3": "Windows ready (or requested OS)",
      "qa.noteT": "Troubleshooting:",
      "qa.noteD": "if the issue can’t be fixed right away, you still get a clear diagnosis and next steps.",
"work.title": "Builds"
    }
  };
